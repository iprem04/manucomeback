...
lyr_station_coordinates_1.set('fieldImages', {'No': '', 'Station_Name': '', 'Address': '', 'Coordinate': '', 'Type': '', 'Longtitude': '', 'Latitude': '', });
lyr_station_coordinates_1.set('fieldLabels', {'No': 'inline label - always visible', 'Station_Name': 'no label', 'Address': 'no label', 'Coordinate': 'no label', 'Type': 'no label', 'Longtitude': 'no label', 'Latitude': 'no label', });
